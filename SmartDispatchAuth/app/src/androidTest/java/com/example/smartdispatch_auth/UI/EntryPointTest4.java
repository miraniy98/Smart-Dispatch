...
public class EntryPointTest4 {
    ...
    public void entryPointTest4() {
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.admin_login_button), withText("Login as an admin"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.scrollView),
                                        0),
        ...
        onView(withId(R.id.current_request)).check(matches(isDisplayed()));
